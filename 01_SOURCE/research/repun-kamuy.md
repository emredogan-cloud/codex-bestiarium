...
**Gerekçe.** KOD DOĞRULANAMADI. Tohum tablosu B472 öneriyor ama Thompson'ın B400–B899 aralığı bu turda erişilen dijital nüshalarda yer almıyor; B472'nin tanımı görülmedi. SOURCING_STANDARD § 5 uyarınca doğrulanmamış kod motifVerified alamaz. Faz 2'de tam Motif-Index nüshasından teyit edilecek; alternatif olarak B471 (yardımcı balık) veya A420 (su tanrısı) değerlendirilecek.
...
Bu madde şu anda YETERSİZ DOĞRULAMA nedeniyle kapıdan geçmiyor. Ainu deniz tanrısı malzemesi tören (inaw sunumu, balina avı ritüeli) ile iç içedir; tören ayrıntısı KULLANILMAZ. Faz 2'de Philippi'nin kamuy yukar çevirilerinden doğrulanmadan yazılmayacak.
...
- ⚠ Motif kodu doğrulanmadı — bu madde Faz 2'de kaynağa dönmeden yazılamaz.
